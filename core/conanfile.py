...
class MyProjectConan(ConanFile):
    ...
    name = 'core'
    version = '1.0'
    requires = 'libcurl/8.6.0', 'libiconv/1.17', 'sqlite3/3.45.1'
    ...
    def layout(self):
        ...
        with open('/Users/yurii/tmp/sl-debug-core.log', 'wt') as fp:
            fp.write(f'current_directory is "{current_directory}"')
